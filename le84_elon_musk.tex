...
\title[Elon Musk, the real Iron Man]{
    How does Elon Musk wants to bring our civilisation, with his strategies, to
    the next level?
}
...
\institute[LE84 - UTBM]{
    Business English (LE84) - Université de Technologie Belfort--Montbéliard}
\date{January 2016}
...
\begin{frame}[noframenumbering,plain]
	\begin{textblock}{0}(0,-29)
        \center{\includegraphics[width=.84\paperwidth]{images/iron-man.jpg}}
	\end{textblock}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\include{sections/convictions}
\include{sections/classic_transportations}
\include{sections/space_travels}
